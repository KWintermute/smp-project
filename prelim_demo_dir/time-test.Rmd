...
plotSkip <- 50
plotUpperBound <- 2000
numPoints <- floor(plotUpperBound / plotSkip)
...
for (i in seq(1, plotUpperBound, by=plotSkip)){
...
#pdf("C:\\Users\\Jarred\\Desktop\\test_output.pdf",width=11,height=8.5,paper='special')
plot((1:numPoints)/40,Haz[2,,2,1]/(1-Haz[1,,2,1]),type="l",xlab="Time",ylab="")
#dev.off()
